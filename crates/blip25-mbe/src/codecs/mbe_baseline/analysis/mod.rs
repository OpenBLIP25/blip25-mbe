...
// Internal re-exports for in-mod tests + cross-submodule helpers that
// were private before the split.
#[cfg(test)]
use basis::unpacked_m;
use basis::floor_i32;
...
pub use pitch::{
    ...
    W_I_HALF, compute_s_lpf, decide_initial_pitch, look_ahead, look_back,
    snap_to_pitch_grid,
};
